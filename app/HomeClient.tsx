        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {[
                { icon: Code, title: 'Build', description: 'Create real projects: apps, websites, games, AI tools, and more' },
                { icon: Lightbulb, title: 'Learn', description: 'Get help from mentors and workshops when you need it' },
                { icon: Trophy, title: 'Showcase', description: 'Demo your project and compete for awards' },
              ].map((benefit, index) => (
      ...
      <section className="py-24 relative">
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xl text-gray-300 mb-8">Sign up to participate in NGN Hacks.</p>
            <Link href="/register">
              <Button className="inline-flex items-center">
                Register Now
                <ArrowRight className="w-5 h-5 ml-2" />
